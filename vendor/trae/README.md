# Artizo Dev Containers for Trae

A dev containers extension for [Trae](https://trae.ai).
...
Artizo Dev Containers provides the same functionality for Trae by leveraging the open-source `@devcontainers/cli` and reimplementing the IDE integration layer from scratch.
