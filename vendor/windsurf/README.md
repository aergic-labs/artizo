# Artizo Dev Containers for Windsurf

A dev containers extension for [Windsurf](https://windsurf.com).
...
Artizo Dev Containers provides the same functionality for Windsurf by leveraging the open-source `@devcontainers/cli` and reimplementing the IDE integration layer from scratch.
